...
core_markets <- c("India", "Korea", "Qatar", "Canada", "Indonesia",
                  "Japan", "Singapore", "USA", "Malaysia", "China",
                  "United Arab Emirates", "New Zealand", "Hong Kong")
bitre_filtered_country <- subset(bitre_data, COUNTRY %in% core_markets)
